...
[errors_abcpgn_random, ~] = abcpgn_random(X, y, w_init, .1/L, tol, max_iters, block_num, @logReg_loss, @logReg_grad, loss_star, 3, lambda);
[errors_abcpgn_cyclic, ~] = abcpgn_cyclic(X, y, w_init, .1/L, tol, max_iters, block_num, @logReg_loss, @logReg_grad, loss_star, 3, lambda);
[errors_abcpgn_shuffled, ~] = abcpgn_shuffled(X, y, w_init, .1/L, tol, max_iters, block_num, @logReg_loss, @logReg_grad, loss_star, 3, lambda);
...
[errors_nesterov_shuffled3, ~] = bcpg_nesterov_shuffled(X, y, w_init, 10/L, tol, max_iters, block_num, @logReg_loss, @logReg_grad, loss_star, lambda);
