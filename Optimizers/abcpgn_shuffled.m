function [errors, grads] = abcpgn_shuffled(X, y, w_init, stepsize0, tol, max_iters, block_num, loss, grad_loss, loss_star, block_update_times, lambda)
w_old = w_init;
grad_old = grad_loss(X, y, w_init);
w = w_init - stepsize0 * grad_old;
w = prox_l1(w, lambda*stepsize0);
